          ...
          <div class="product-detail-container p-2">
            ...
            <div class="d-flex justify-content-between align-items-center pt-1">
              <div class="color-select d-flex">
                <input id="btn" type="button" name="grey" class="creme" />
                <input id="btn" type="button" name="red" class="red ml-2" />
                <input id="btn" type="button" name="blue" class="blue ml-2" />
              </div>
            </div>
...
export default {
  ...
  methods: {
    async fetchProducts() {
      try {
        const response = await axios.get(`https://fakestoreapi.com/products/category/${this.slug}`)
